...
# ACDS 17.0 595 win32 2018.03.22.21:24:33
# ----------------------------------------
...
# ----------------------------------------
# If fivetoten is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fivetoten.vho"
}
